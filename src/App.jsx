          ...
          <div className="">
            <div className="">
              ...
              >
                ...
                >
                  <div
                    className="flex flex-col items-center justify-start col-lg-3 col-md-4"
                    style={{
                        height: 280
                    }}
                  >
...
style={{
  width: 150,
                  ...
                  <div
                    className="flex flex-col items-center justify-center col-lg-12 col-md-4 text-lg-center"
                    style={{
                        height: 280
...
style={{
  width: 150,
                ...
                >
                  <div
                    className="leftSection mr-5 text-center"
                    style={{
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            flexDirection: width > 1024 ? "row" : "column",
                            paddingTop: 20,
                            marginLeft: width > 1024 ? 5 : width > 768 ? 100 : width > 600 ? 220: width > 481 ? 150: 0,
                          }}
                        >
                          <img
